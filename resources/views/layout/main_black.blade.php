                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link" href="/talentsearch">Institutions</a>
                            <a class="nav-link" href="#">Register</a>
                            <a class="nav-link" href="#">Sign in</a>
                            <div class="btn-group">
                                <img class="bahasa" src="{{ asset('img/united-states.png') }}" alt="">
                                <img id="toggle" class="dropdown-toggle dropdown-toggle-split" src="{{ asset('img/drop.png') }}" alt="" id="dropdownMenuReference" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-reference="parent">
                                </button>
                                <div class="dropdown-menu dropdown-menu-right" id="lebar">
                                <h6 class="dropdown-header text-center">Language</h6>
                                <a class="dropdown-item active" href="#"><img src="{{ asset('img/united-states.png') }}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </nav>
