    ...
    <div class="row">
        <div class="col-md-3">
            <div class="kategori">
                ...
                <a href="/employer/talentsearch/profile/{{ $pelamar->id }}/backgroundeducation"><button class="backed text-center aktif2">Background Education</button></a>
        ...
        <div class="col-md-9">
                <div class="hobbybox">
                    <div class="konten">
                        ...
                        <p class="tanggal"><b>May 2007 - Dec 2010</b> <span class="univ">{{ $pelamar->pendidikan }}</span></p>
                        <div class="bwah">
                            <p class="master">Master's Degree Graduate</p>
                            <p class="major">Major <span class="grey">{{ $pelamar->fakultas }}</span></p>
                            <p class="gpa">GPA <span class="grey">{{ $pelamar->ipk }}</span></p>
                        </div>
                    </div>
                </div>
        </div>
