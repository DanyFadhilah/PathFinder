    ...
    <div class="row">
        <div class="col-md-3">
            <div class="kategori">
                ...
                <a href="/employer/talentsearch/profile/{{ $pelamar->id }}/project"><button class="projects text-center">Projects</button></a>
                ...
                <a href="/employer/talentsearch/profile/{{ $pelamar->id }}/professionalskills"><button class="profskill text-center aktif2">Professional Skills</button></a>
                ...
                <div class="hobbybox">
                    <div class="konten">
                        ...
                        <div class="bwah">
                            <div class="skill">
                                <ul>
                                    <li><span class="hitam">Adobe XD</span></li>
                                    <li><span class="hitam">Photoshop</span></li>
                                    <li><span class="hitam">Microsoft Excel</span></li>
                                </ul>
                            </div>
                            <div class="tingkat">
                                <div class="ting1">Advanced</div>
                                <div class="ting2">Advanced</div>
                                <div class="ting3">Intermediate</div>
                            </div>
                        </div>
                    </div>
                </div>
